...
$visibility_1_projet_child =  $_POST["visibility_1_projet_child"] ;  
...
$databaseHandler->action_sql('UPDATE `projet_child` SET `visibility_1_projet_child` = "'.$visibility_1_projet_child.'" WHERE `id_projet_child` = "'.$id_projet_child.'"') ;
